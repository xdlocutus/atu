...
<div class="right" style="margin-top:12px">Subtotal: R <?= number_format((float)$quote['subtotal'],2) ?><br>VAT: R <?= number_format((float)$quote['vat_amount'],2) ?><br><strong>Total: R <?= number_format((float)$quote['total'],2) ?></strong></div>

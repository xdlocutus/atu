...
<?php foreach ($quote['items'] as $item): ?><tr><td><?= htmlspecialchars((string)$item['description'], ENT_QUOTES, 'UTF-8') ?></td><td><?= htmlspecialchars((string)$item['quantity'], ENT_QUOTES, 'UTF-8') ?></td><td><?= number_format((float)$item['rate'],2) ?></td><td><?= number_format((float)$item['subtotal'],2) ?></td></tr><?php endforeach; ?>
</tbody></table>
<div class="right" style="margin-top:12px">Subtotal: <?= number_format((float)$quote['subtotal'],2) ?><br>VAT: <?= number_format((float)$quote['vat_amount'],2) ?><br><strong>Total: <?= number_format((float)$quote['total'],2) ?></strong></div>

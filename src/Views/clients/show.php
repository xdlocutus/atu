...
<?php if ($tab === 'files'): ?>
  <div class="card card-soft mb-3"><div class="card-body">
    ...
    <form method="post" enctype="multipart/form-data" class="row g-2">
      ...
      <div class="col-md-4"><input class="form-control" type="file" name="upload" required/></div>
  ...
  <div class="card card-soft"><div class="card-body"><h5>Client Files</h5><div class="table-responsive"><table class="table"><thead><tr><th>Category</th><th>Name</th><th>Size</th><th>Notes</th><th>Date</th></tr></thead><tbody>
  <?php foreach ($documents as $d): ?><tr><td><?= htmlspecialchars((string)$d['category'], ENT_QUOTES, 'UTF-8') ?></td><td><?= htmlspecialchars((string)$d['original_name'], ENT_QUOTES, 'UTF-8') ?></td><td><?= number_format(((int)$d['size_bytes'])/1024, 1) ?> KB</td><td><?= htmlspecialchars((string)($d['notes'] ?? ''), ENT_QUOTES, 'UTF-8') ?></td><td><?= htmlspecialchars((string)$d['created_at'], ENT_QUOTES, 'UTF-8') ?></td></tr><?php endforeach; ?>
  <?php if (empty($documents)): ?><tr><td colspan="5" class="text-secondary">No files uploaded yet.</td></tr><?php endif; ?>
...
<?php if ($tab === 'invoices'): ?>
  ...
  <div class="card card-soft"><div class="card-body"><h5>Invoices</h5><table class="table"><thead><tr><th>Invoice #</th><th>Status</th><th>Due</th><th>Total</th><th>Paid</th><th>Balance</th></tr></thead><tbody>
  <?php foreach ($invoices as $i): ?><tr><td><?= htmlspecialchars((string)$i['invoice_number'], ENT_QUOTES, 'UTF-8') ?></td><td><?= htmlspecialchars((string)$i['status'], ENT_QUOTES, 'UTF-8') ?></td><td><?= htmlspecialchars((string)$i['due_date'], ENT_QUOTES, 'UTF-8') ?></td><td>R <?= number_format((float)$i['total'],2) ?></td><td>R <?= number_format((float)$i['amount_paid'],2) ?></td><td>R <?= number_format((float)$i['balance_due'],2) ?></td></tr><?php endforeach; ?>
  <?php if (empty($invoices)): ?><tr><td colspan="6" class="text-secondary">No invoices yet.</td></tr><?php endif; ?>
  </tbody></table></div></div>
<?php endif; ?>
...
<?php if ($tab === 'payments'): ?>
  ...
  <div class="card card-soft"><div class="card-body"><h5>Payments</h5><table class="table"><thead><tr><th>Date</th><th>Invoice</th><th>Amount</th><th>Method</th><th>Reference</th></tr></thead><tbody>
  ...
  <?php if (empty($payments)): ?><tr><td colspan="5" class="text-secondary">No payments yet.</td></tr><?php endif; ?>
  </tbody></table></div></div>
<?php endif; ?>

<?php if ($tab === 'statements'): ?>
  <div class="card card-soft"><div class="card-body"><h5>Statement</h5><p class="text-secondary">Per-client statement summary.</p>
